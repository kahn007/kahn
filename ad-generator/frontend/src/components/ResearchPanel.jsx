...
import { Search, Zap, TrendingUp, MessageSquare, Target, AlertCircle, RefreshCw, Plus, Trash2, ChevronRight, BookOpen, Clock } from 'lucide-react'
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-sm">
            Each research is saved — build a library for different products and audiences.
          </p>
        </div>
        <button
